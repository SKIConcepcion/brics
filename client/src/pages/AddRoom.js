...
export default function AddRoom(prop) {
    ...
    const [files, setPictures] = useState([]);
        ...
        try {
            ...
            if(files){
                ...
                if (base64s) {
                    ...
                    room.pictures = uploadFileResponse.data;
                    // alert("File uploaded successfully!");
                }
            }

            const response = await axios.post('https://brics-api.vercel.app/api/rooms/create-room', room, {withCredentials: true});
    ...
    const computerAmen = {
        label: "Computer",
        placeholder: "e.g. 20",
        icon: <svg className="flex-shrink-0 size-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="14" x="2" y="3" rx="2"/><line x1="8" x2="16" y1="21" y2="21"/><line x1="12" x2="12" y1="17" y2="21"/></svg>
    }
    ...
    const micAmen = {
        ...
        icon: <svg className="flex-shrink-0 size-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m12 8-9.04 9.06a2.82 2.82 0 1 0 3.98 3.98L16 12"/><circle cx="17" cy="7" r="5"/></svg>
    }
            ...
            <div className="flex-col">
                ...
                <div className='flex mt-3' style={{marginLeft: MarginLeft }}>
                    ...
                    <div className='flex-col ml-5'>
                        <h1 className="text-3xl font-bold text-brics-blue text-left">Add Room</h1>
                        <h2 className="text-lg text-gray-500 text-left">Enter information about room</h2>
                    </div>
                </div>
                {/* End of Page Header */}
                {/* Start of Form */}
                <div className='flex flex-col mt-3' style={{marginLeft: MarginLeft }}>
                    ...
                    <div className='flex w-full justify-between mt-3 mb-10'>
                        ...
                        <button type="submit" onClick={(e)=>handleCreateRoom(e)} className="w-full mr-6 py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-brics-blue text-white text-center hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none justify-center">
                            Create Room
                        </button>
                        {/* Snackbar */}
